        ...
        <button class="btn btn-lg btn-with-google btn-block btn-outline-dark">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
              ...
              fill="#28B446" />
            <path d="M19.6596 2.76263L15.7721 5.94525C14.6783 5.26153 13.3853 4.86656 12 4.86656C8.87213 4.86656 6.21431 6.88017 5.25169 9.68175L1.34245 6.48131H1.3418C3.33895 2.63077 7.36223 0 12 0C14.9117 0 17.5814 1.03716 19.6596 2.76263Z"
              fill="#F14336" />
          </svg>
          <span class="d-none d-sm-inline">{{text}} With Google</span>
        </button>
      </div>
      <div class="col-auto">
