    ...
    <div class="row">
      ...
      <div class="col-xl-3 col-md-4">
        <div class="panel-right">
          ...
          <div class="bg-white mb-3 p-2 rounded shadow code">
            <svg width="40" height="24" viewBox="0 0 12 6" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd" clip-rule="evenodd" d="M5.28708 1.92541H11.2194C11.6461 1.92541 12 2.27927 12 2.70598V4.6314C12 5.06852 11.6461 5.41197 11.2194 5.41197C10.7823 5.41197 10.4389 5.06852 10.4389 4.6314V3.48656H9.05464V4.6314C9.05464 5.06852 8.70078 5.41197 8.27407 5.41197C7.83695 5.41197 7.4935 5.06852 7.4935 4.6314V3.48656H5.28708C4.95403 4.60017 3.93408 5.41197 2.71639 5.41197C1.21769 5.41197 0 4.20468 0 2.70598C0 1.21769 1.21769 0 2.71639 0C3.93408 0 4.95403 0.811795 5.28708 1.92541ZM1.5613 2.70614C1.5613 3.341 2.08168 3.85098 2.71655 3.85098C3.341 3.85098 3.86138 3.341 3.86138 2.70614C3.86138 2.07127 3.341 1.5613 2.71655 1.5613C2.08168 1.5613 1.5613 2.07127 1.5613 2.70614Z" fill="#FC622C"/>
            </svg>
            <span class="ml-3">{{ data.code }}</span>
          </div>
