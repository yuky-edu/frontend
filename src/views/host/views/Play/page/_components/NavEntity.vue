    ...
    <div class="container-fluid">
      ...
      <div class="navbar-brand w-25" href="#">
        ...
        <div class="dropdown dropdown-entity">
          ...
          <div v-for="(item, index) in $parent.$parent.entities" class="dropdown-menu">
            <button class="btn btn-light dropdown-item" type="button">
              ...
              <!-- <span>{{index+1}}. {{item.question.substr(0, 10)}}</span> -->
              <span>Lorem ipsum dolor.</span>
            </button>
            <button  class="btn btn-light dropdown-item" type="button">
              ...
              <!-- <span>{{index+1}}. {{item.theory.substr(0, 10)}}</span> -->
              <span>Lorem ipsum dolor.</span>
            </button>
          </div>
        </div>
